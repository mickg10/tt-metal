...
class FlashMLADecode:
    ...
    def op(
        ...
        for i in range(num_active_cores):
            ...
            # Separate VCs for left vs right S blocks to avoid NOC congestion
            # Left (S1-S4, indices 0-3): VC 0-1
            # Right (S5-S8, indices 4-7): VC 2-3
            if s_block_idx < 4:
                vc = s_block_idx & 0x1  # Left: VC 0 or 1
            else:
                vc = 2 + ((s_block_idx - 4) & 0x1)  # Right: VC 2 or 3
