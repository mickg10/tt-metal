...
void kernel_main() {
    ...
    deepseek_b1_ops::KVCacheUpdate::ReaderArgs args{.kv_cache_buffer_base_addr = get_common_arg_val<uint32_t>(0)};
    ...
    deepseek_b1_ops::KVCacheUpdate::ComputeArgs args{.kv_cache_num_tiles = 16};
#endif
