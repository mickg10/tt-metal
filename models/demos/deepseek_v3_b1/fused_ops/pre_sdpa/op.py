    ...
    def op(
        ...
        for row in range(mesh_rows):
            ...
            for col in range(mesh_cols):
                ...
                # CB 15: CreateQHeads output buffer (tilized data, backed by output tensor)
                ...
                unified_kernel = UnifiedKernelDescriptor(
                    ...
                    # BRISC named compile-time args: bcast + rmsnorm reader (for gamma setup) + mcast sender + matmul + gather receiver + matmul2 + mcast2 + matmul3 + qrope + create_q_heads + dkv_matmul + dkv_gather_receiver + kv_rmsnorm
                    ...
                    # TRISC named compile-time args: rmsnorm compute + matmul + rmsnorm2 + matmul2 + matmul3 + qrope + create_q_heads + dkv_matmul + kv_rmsnorm + krope
                ...
                cbs_list = [
                    ...
                    create_q_heads_out_cb_descriptor,  # CB 15: CreateQHeads output (tilized, linked to tensor)
