...
import ttnn
from models.demos.glm_moe_dsa.unified_kernel_descriptor import (
...
class DRAMStreamingExpertsMatmul:
    ...
    def op(
        ...
        # Core logic is in unified_kernels/dram_streaming_matmul.hpp
        KERNEL_PATH = "models/demos/glm_moe_dsa/micro_ops/dram_streaming_experts_matmul/kernels/dram_streaming_experts_matmul_kernel.cpp"
