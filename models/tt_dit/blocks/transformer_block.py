...
class TransformerBlock(Module):
    ...
    def forward(
        ...
        *,
        ...
        spatial_normed = ttnn.squeeze(self.norm1_norm(ttnn.unsqueeze(spatial, 0), use_old=True), 0)
        ...
        prompt_normed = ttnn.squeeze(self.norm1_context_norm(ttnn.unsqueeze(prompt, 0), use_old=True), 0)
        ...
        spatial_normed = ttnn.squeeze(self.norm2(ttnn.unsqueeze(spatial_plus_attn, 0), use_old=True), 0)
        ...
        prompt_normed = ttnn.squeeze(self.norm2_context(ttnn.unsqueeze(prompt_plus_attn, 0), use_old=True), 0)
